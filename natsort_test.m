...
% * natsort.m & test_nso_fun.m from <www.mathworks.com/matlabcentral/fileexchange/34464>
%
% See also NATSORT TEST_NSO_FUN ARBSORT_TEST NATSORTFILES_TEST NATSORTROWS_TEST
obj = test_nso_fun(@natsort);
nsoMain(obj) % count
obj.start()
nsoMain(obj) % check
obj.finish()
...
%
A =        txf({'x2','x10','x1'});
chk.i(A).o(txf({'x1','x2','x10'}))
chk.i(A).o(                    @i,      @i, {'x',2;'x',10;'x',1})
chk.i(A).o(txf({'x1','x2','x10'}),      @i, {'x',2;'x',10;'x',1}) % not in Mfile
chk.i(A).o(txf({'x1','x2','x10'}), [3,1,2], {'x',2;'x',10;'x',1}) % not in Mfile
chk.i(A).o(txf({'x1','x2','x10'}), [3,1,2]) % not in Mfile
%
chk.i(... Aa
	{'v10.6','v9.10','v9.5','v10.10','v9.10.20','v9.10.8'}).o(...
	{'v9.5','v9.10','v9.10.8','v9.10.20','v10.6','v10.10'}, [3,2,6,5,1,4])
chk.i(... Ab
	{'test+NaN','test11.5','test-1.4','test','test-Inf','test+0.3'}, '[+-]?(Inf|\d+\.?\d*)').o(...
	{'test','test-Inf','test-1.4','test+0.3','test11.5','test+NaN'}, [4,5,3,6,2,1])
chk.i(... Ac
	{'0.56e007','','43E-2','10000','9.8'}, '\d+\.?\d*(E[+-]?\d+)?').o(...
	{'','43E-2','9.8','10000','0.56e007'}, [2,3,5,4,1])
chk.i(... Ad
	{'a0X7C4z','a0X5z','a0X18z','a0XFz'}, '0X[0-9A-F]+', '%i').o(...
	{'a0X5z','a0XFz','a0X18z','a0X7C4z'}, [2,4,3,1])
chk.i(... Ae
	{'a11111000100z','a101z','a000000000011000z','a1111z'}, '[01]+', '%b').o(...
	{'a101z','a1111z','a000000000011000z','a11111000100z'}, [2,4,3,1])
%
Af =                          {'a2','A20','A1','a10','A2','a1'};
chk.i(Af, [], 'ignorecase').o({'A1','a1','a2','A2','a10','A20'}, [3,6,1,5,4,2]) % default
chk.i(Af, [], 'matchcase' ).o({'A1','A2','A20','a1','a2','a10'}, [3,5,2,6,1,4])
chk.i(Af).o(@i, [3,6,1,5,4,2], {'a',2;'A',20;'A',1;'a',10;'A',2;'a',1}) % not in Mfile
%
Ag =                        {'2','a','','3','B','1'};
chk.i(Ag, [],   'ascend').o({'','1','2','3','a','B'}, [3,6,1,4,2,5]) % default
chk.i(Ag, [],  'descend').o({'B','a','3','2','1',''}, [5,2,4,1,6,3])
chk.i(Ag, [], 'num<char').o({'','1','2','3','a','B'}, [3,6,1,4,2,5]) % default
chk.i(Ag, [], 'char<num').o({'','a','B','1','2','3'}, [3,2,5,6,1,4])
chk.i(Ag).o(@i, [3,6,1,4,2,5], {2;'a';[];3;'B';1}) % not in Mfile
%
if isl
	Ah =                   {'a18446744073709551615z','a18446744073709551614z'};
	chk.i(Ah, [], '%lu').o({'a18446744073709551614z','a18446744073709551615z'}, [2,1])
	chk.i(Ah, [], '%lu').o(@i, [2,1], {'a',uint64(18446744073709551615),'z';'a',uint64(18446744073709551614),'z'}) % not in Mfile
	u64 = intmax('uint64');
	chk.i({dec2bin(u64-1,64);dec2bin(u64,64)}, '[01]+', '%lb').o({...
...
%
Aa =        txf({'a2','a10','a1'});
chk.i(Aa).o(txf({'a1','a2','a10'}))
chk.i(Aa).o(txf({'a1','a2','a10'}), [3,1,2]) % not in HTML
chk.i(Aa).o(@i, [3,1,2], {'a',2;'a',10;'a',1}) % not in HTML
%
Db = {'v',9,'.',10,[],[];'v',9,'.',5,[],[];'v',9,'.',2,[],[];'v',9,'.',10,'.',20;'v',9,'.',10,'.',8};
Ab =        txf({'v9.10','v9.5','v9.2','v9.10.20','v9.10.8'});
chk.i(Ab).o(txf({'v9.2','v9.5','v9.10','v9.10.8','v9.10.20'}))
chk.i(Ab).o(txf({'v9.2','v9.5','v9.10','v9.10.8','v9.10.20'}), [3,2,1,5,4]) % not in HTML
chk.i(Ab).o(@i, [3,2,1,5,4], Db) % not in HTML
chk.i(Ab).o(@i, @i, Db) % not in HTML
%
if isc
	Dc = {'a',2;'a',10;'a',1};
	Ac =        categorical({'a2','a10','a1'});
	chk.i(Ac).o(categorical({'a1','a2','a10'}));
	chk.i(Ac).o(categorical({'a1','a2','a10'}), [3,1,2]) % not in HTML
	chk.i(Ac).o(@i, [3,1,2], Dc) % not in HTML
	chk.i(Ac).o(@i, @i, Dc) % not in HTML
end
%
Ad =                    {'1.3','1.10','1.2'};
chk.i(Ad            ).o({'1.2','1.3','1.10'})
chk.i(Ad            ).o({'1.2','1.3','1.10'}, [3,1,2]) % not in HTML
chk.i(Ad            ).o({'1.2','1.3','1.10'}, [3,1,2], {1,'.',3;1,'.',10;1,'.',2}) % not in HTML
chk.i(Ad, '\d\.?\d*').o({'1.10','1.2','1.3'})
chk.i(Ad, '\d\.?\d*').o({'1.10','1.2','1.3'}, [2,3,1]) % not in HTML
chk.i(Ad, '\d\.?\d*').o({'1.10','1.2','1.3'}, [2,3,1], {1.3;1.1;1.2}) % not in HTML
%
Ae =                          {'a2','A20','A1','a','A','a10','A2','a1'};
chk.i(Ae, [], 'ignorecase').o({'a','A','A1','a1','a2','A2','a10','A20'})
chk.i(Ae, [], 'ignorecase').o({'a','A','A1','a1','a2','A2','a10','A20'}, [4,5,3,8,1,7,6,2]) % not in HTML
chk.i(Ae, [],  'matchcase').o({'A','A1','A2','A20','a','a1','a2','a10'})
chk.i(Ae, [],  'matchcase').o({'A','A1','A2','A20','a','a1','a2','a10'}, [5,3,7,2,4,8,1,6]) % not in HTML
chk.i(Ae).o(@i, [4,5,3,8,1,7,6,2], {'a',2;'A',20;'A',1;'a',[];'A',[];'a',10;'A',2;'a',1}) % not in HTML
%
Af =                        {'2','a','','10','B','1'};
chk.i(Af, [],   'ascend').o({'','1','2','10','a','B'}, [3,6,1,4,2,5]) % index not in HTML
chk.i(Af, [],  'descend').o({'B','a','10','2','1',''}, [5,2,4,1,6,3]) % index not in HTML
chk.i(Af, [], 'num<char').o({'','1','2','10','a','B'}, [3,6,1,4,2,5]) % index not in HTML
chk.i(Af, [], 'char<num').o({'','a','B','1','2','10'}, [3,2,5,6,1,4]) % index not in HTML
chk.i(Af).o(@i, [3,6,1,4,2,5], {2;'a';[];10;'B';1}) % Not in HTML
%
Ag =                              {'10','1','NaN','2'};
chk.i(Ag, 'NaN|\d+', 'num<NaN').o({'1','2','10','NaN'}, [2,4,1,3]) % index not in HTML
chk.i(Ag, 'NaN|\d+', 'NaN<num').o({'NaN','1','2','10'}, [3,2,4,1]) % index not in HTML
chk.i(Ag, 'NaN|\d+').o(@i, [2,4,1,3], {10;1;NaN;2}) % Not in HTML
%
if isl
	Ah =                   {'18446744073709551614','18446744073709551615','18446744073709551613'};
	chk.i(Ah, [], '%lu').o({'18446744073709551613','18446744073709551614','18446744073709551615'})
	chk.i(Ah, [], '%lu').o({'18446744073709551613','18446744073709551614','18446744073709551615'}, [3,1,2]) % not in HTML
	chk.i(Ah, [], '%lu').o(@i, [3,1,2], {uint64(18446744073709551614);uint64(18446744073709551615);uint64(18446744073709551613)}) % not in HTML
end
%
if isa && iss
	alfabeto = num2cell(['A':'N','Ñ','O':'Z']); % Spanish alphabet
	Fi = @(t)arbsort(t,alfabeto);
	Ai = txf({'ña_2', 'ño', 'os', 'ña_10', 'ni', 'ña_1'});
	chk.i(Ai, [], Fi).o(txf({'ni', 'ña_1', 'ña_2', 'ña_10', 'ño', 'os'}))
	chk.i(Ai, [], Fi).o(@i, [5,6,1,4,2,3]) % not in HTML
	chk.i(Ai, [], Fi).o(@i, [5,6,1,4,2,3], {'ña_',2;'ño',[];'os',[];'ña_',10;'ni',[];'ña_',1}) % not in HTML
end
%
Dk = {'abc',2,'xyz';'abc',10,'xyz';'abc',2,'xyz';'abc',1,'xyz'};
Ak =        {'abc2xyz','abc10xyz','abc2xyz','abc1xyz'};
chk.i(Ak).o({'abc1xyz','abc2xyz','abc2xyz','abc10xyz'}) % not in HTML
chk.i(Ak).o({'abc1xyz','abc2xyz','abc2xyz','abc10xyz'}, [4,1,3,2])
chk.i(Ak).o({'abc1xyz','abc2xyz','abc2xyz','abc10xyz'}, [4,1,3,2], Dk) % not in HTML
chk.i(Ak).o(@i, @i, Dk)
%
chk.i(...Am
	{'x+NaN','x11.5','x-1.4','x','x-Inf','x+0.3'}, '[+-]?(NaN|Inf|\d+\.?\d*)').o(...
	{'x','x-Inf','x-1.4','x+0.3','x11.5','x+NaN'}, [4,5,3,6,2,1]) % index not in HTML
chk.i(... An
	{'0.56e007','','43E-2','10000','9.8'}, '[+-]?\d+\.?\d*(E[+-]?\d+)?').o(...
	{'','43E-2','9.8','10000','0.56e007'}, [2,3,5,4,1]) % index not in HTML
chk.i(... Ao
	{'a0X7C4z','a0X5z','a0X18z','a0XFz'}, '0X[0-9A-F]+', '%x').o(...
...
Dq = {' ',9;23,[];10,[];' ',0;5,' '};
Aq =                     [' 9';'23';'10';' 0';'5 '];
chk.i(Aq             ).o(['5 ';'10';'23';' 0';' 9'])
chk.i(Aq             ).o(['5 ';'10';'23';' 0';' 9'], [5;3;2;4;1], Dq) % not in HTML
chk.i(Aq, '\s*\d+\s*').o([' 0';'5 ';' 9';'10';'23'])
chk.i(Aq, '\s*\d+\s*').o([' 0';'5 ';' 9';'10';'23'], [4;5;1;3;2], {9;23;10;0;5}) % not in HTML
chk.i(Aq             ).o(@i, @i, Dq) % not in HTML
chk.i(Aq             ).o(@i, [5;3;2;4;1], Dq) % not in HTML
chk.i(Aq, '\s*\d+\s*').o(@i, [4;5;1;3;2], {9;23;10;0;5}) % not in HTML
%
if isc
	Ar = txf({'a2', 'a10', 'a1'});
	Cr = categories(categorical(Ar));
	chk.i(Cr).o({'a1';'a2';'a10'})
	chk.i(Cr).o({'a1';'a2';'a10'}, [1;3;2]) % not in HTML
	chk.i(Cr).o({'a1';'a2';'a10'}, [1;3;2], {'a',1;'a',10;'a',2}) % not in HTML
end
%
As =                    txf({'1,3', '1,10', '1,2'});
...
%
% unsigned integer:
chk.i({'0','123','4','56789'}, '\d+',  '%f').o({'0','4','123','56789'}, [1,3,2,4], {0;123;4;56789})
chk.i({'0','123','4','56789'}, '\d+',  '%i').o({'0','4','123','56789'}, [1,3,2,4], {0;123;4;56789})
chk.i({'0','123','4','56789'}, '\d+',  '%u').o({'0','4','123','56789'}, [1,3,2,4], {0;123;4;56789})
chk.i({'0','123','4','56789'}, '\d+', '%lu').o({'0','4','123','56789'}, [1,3,2,4], {0;123;4;56789})
% signed integer:
chk.i({'+1','23','-45','678'}, '[+-]?\d+',  '%f').o({'-45','+1','23','678'}, [3,1,2,4], {1;23;-45;678})
chk.i({'+1','23','-45','678'}, '[+-]?\d+',  '%i').o({'-45','+1','23','678'}, [3,1,2,4], {1;23;-45;678})
chk.i({'+1','23','-45','678'}, '[+-]?\d+',  '%d').o({'-45','+1','23','678'}, [3,1,2,4], {1;23;-45;678})
chk.i({'+1','23','-45','678'}, '[+-]?\d+', '%ld').o({'-45','+1','23','678'}, [3,1,2,4], {1;23;-45;678})
% floating point:
chk.i({'012','3.45','678.9'}, '\d+\.?\d*',    '%f').o( {'3.45','012','678.9'}, [2,1,3], {12;3.45;678.9})
chk.i({'123','4','NaN','Inf'}, '\d+|Inf|NaN', '%f').o( {'4','123','Inf','NaN'}, [2,1,4,3], {123;4;NaN;Inf})
chk.i({'0.123e4','5.67e08'}, '\d+\.\d+E\d+'       ).o( {'0.123e4','5.67e08'}, [1,2], {0.123e4;5.67e08})
% octal:
chk.i({'0O12','0O3456','0O700'}, '0O[0-7]+', '%i').o({'0O12','0O700','0O3456'}, [1,3,2], {10;1838;448})
chk.i({'0O12','0O3456','0O700'}, '0O[0-7]+', '%o').o({'0O12','0O700','0O3456'}, [1,3,2], {10;1838;448})
chk.i({  '12',  '3456',  '700'},   '[0-7]+', '%o').o({  '12',  '700',  '3456'}, [1,3,2], {10;1838;448})
% hexadecimal:
chk.i({'0X0','0X3E7','0XFF'}, '0X[0-9A-F]+', '%i').o({'0X0','0XFF','0X3E7'}, [1,3,2], {0;999;255})
chk.i({'0X0','0X3E7','0XFF'}, '0X[0-9A-F]+', '%x').o({'0X0','0XFF','0X3E7'}, [1,3,2], {0;999;255})
chk.i({  '0',  '3E7',  'FF'},   '[0-9A-F]+', '%x').o({  '0',  'FF',  '3E7'}, [1,3,2], {0;999;255})
% binary:
chk.i({'0B1','0B101','0B10'}, '0B[01]+', '%b').o({'0B1','0B10','0B101'}, [1,3,2], {1;5;2})
chk.i({  '1',  '101',  '10'},   '[01]+', '%b').o({  '1',  '10',  '101'}, [1,3,2], {1;5;2})
%
%% Octal %%
%
chk.i({'0o1','0o10','0o2'}, '0[oO][0-7]+', '%o').o({'0o1','0o2','0o10'},[1,3,2],{1;8;2}) % with prefix
chk.i({'010','0o10','02','0o2'}, '0[oO]?[0-7]+', '%o').o({'02','0o2','010','0o10'}, [3,4,1,2], {8;8;2;2}) % with/out prefix
chk.i({'0o7','07','0o10','010'}, '0[oO]?[0-7]+', '%i').o(@i,@i,{7;7;8;8}) % autodetect base (%i)
chk.i({'0o0','0o00','0o000'}, '0[oO][0-7]+', '%o').o(@i,@i,{0;0;0}) % zero
chk.i({'a0o2b','a0o10b'}, '0[oO][0-7]+', '%o').o(@i,@i,{'a',2,'b'; 'a',8,'b'}) % embedded
%
%% Binary UINT64 %%
%
chk.i({'1','10','11','100'}, '[01]+', '%lb').o({'1','10','11','100'}, [1,2,3,4])
chk.i({'1','10','11','100'}, '[01]+', '%lb').o(@i,@i,num2cell(uint64([1;2;3;4])))
chk.i({'0b1','0b10','0b11','0b0'}, '0[bB][01]+', '%lb').o({'0b0','0b1','0b10','0b11'}, [4,1,2,3]) % prefix
chk.i({'0b1','0b10','0b11','0b0'}, '0[bB][01]+', '%lb').o(@i,@i,num2cell(uint64([1;2;3;0]))) % prefix
chk.i({'101','0b10','11','0b1'}, '(0[bB])?[01]+', '%lb').o({'0b1','0b10','11','101'}, [4,2,3,1]) % mixed
chk.i({'101','0b10','11','0b1'}, '(0[bB])?[01]+', '%lb').o(@i,@i,num2cell(uint64([5;2;3;1])))
chk.i({'0','00','000','0000'}, '[01]+', '%lb').o(@i,@i,num2cell(uint64([0;0;0;0]))) % zero
chk.i({repmat('1',1,64)}, '[01]+', '%lb').o(@i,@i,{intmax('uint64')}) % INTMAX
chk.i({'a1z','a10z','a11z','a100z'}, '[01]+', '%lb').o(@i,@i,...
	[{'a';'a';'a';'a'},num2cell(uint64([1;2;3;4])),{'z';'z';'z';'z'}]) % embedded
%
%% Mixed-Base (%i) %%
%
rgx = '0([xX][0-9A-F]+|[oO]?[0-7]+)|\d+';
chk.i({'10','0x10','010','0o10'}, rgx, '%i').o({'010','0o10','10','0x10'}, [3,4,1,2], {10;16;8;8})
chk.i({'a10z','a0x10z','a010z','a0o10z'}, rgx, '%i').o(@i,@i, {'a',10,'z'; 'a',16,'z'; 'a',8,'z'; 'a',8,'z'})
chk.i({'0b10','10','0x10','010'}, rgx, '%i').o(...
	@i,@i, {0,'b',10; 10,[],[]; 16,[],[]; 8,[],[]}) % no binary
chk.i({'10x','0x10y'}, rgx, '%i').o(@i,@i, {10,'x'; 16,'y'}) % leading numbers
chk.i({'0','00','0x0','0o0'}, rgx, '%i').o(@i,@i, {0; 0; 0; 0}) % zeros
...
%
C =        {'BAA','AA','CA','B','A','C'};
chk.i(C).o({'A','AA','B','BAA','C','CA'}, [5,2,4,1,6,3], C(:))
%
C =        {'100','00','20','1','0','2'};
chk.i(C).o({'00','0','1','2','20','100'}, [2,5,4,6,3,1], num2cell(str2double(C(:))))
%
C = {'000000000','0','00000','00','000','00000000','0','0000','000000'};
chk.i(C).o(C, 1:numel(C), num2cell(zeros(numel(C),1)))
C = {'000000001','1','00001','01','001','00000001','1','0001','000001'};
chk.i(C).o(C, 1:numel(C), num2cell(ones(numel(C),1)))
C = {'000000001','2','00003','04','005','00000006','7','0008','000009'};
chk.i(C).o(C, 1:numel(C), num2cell((1:numel(C)).'))
C = {'NaN','NaN','NaN','NaN','NaN','NaN','NaN','NaN','NaN','NaN','NaN'};
chk.i(C, 'NaN|\d+').o(C, 1:numel(C), num2cell(nan(numel(C),1)))
C = {'+Inf','+Inf','+Inf','+Inf','+Inf','+Inf','+Inf','+Inf','+Inf'};
chk.i(C, '[+-]?Inf|\d+').o(C, 1:numel(C), num2cell(+inf(numel(C),1)))
C = {'-Inf','-Inf','-Inf','-Inf','-Inf','-Inf','-Inf','-Inf','-Inf'};
chk.i(C, '[+-]?Inf|\d+').o(C, 1:numel(C), num2cell(-inf(numel(C),1)))
%
%% Input Classes %%
...
if isl
	...
	chk.i(u2c(magic(0)), [], '%lu').o(u2c(00:-1:1))
	chk.i(u2c(magic(1)), [], '%lu').o(u2c(01:-1:1))
	chk.i(u2c(magic(2)), [], '%lu').o(u2c(04:-1:1))
	chk.i(u2c(magic(3)), [], '%lu').o(u2c(09:-1:1))
	chk.i(u2c(magic(4)), [], '%lu').o(u2c(16:-1:1))
	chk.i(u2c(magic(5)), [], '%lu').o(u2c(25:-1:1))
	chk.i(u2c(magic(6)), [], '%lu').o(u2c(36:-1:1))
	chk.i(u2c(magic(7)), [], '%lu').o(u2c(49:-1:1))
	chk.i(u2c(magic(8)), [], '%lu').o(u2c(64:-1:1))
	chk.i(u2c(magic(9)), [], '%lu').o(u2c(81:-1:1))
	chk.i(u2c(magic(0)), [], '%lu',  'ascend').o(u2c(00:-1:1))
	chk.i(u2c(magic(1)), [], '%lu',  'ascend').o(u2c(01:-1:1))
	chk.i(u2c(magic(2)), [], '%lu',  'ascend').o(u2c(04:-1:1))
	chk.i(u2c(magic(3)), [], '%lu',  'ascend').o(u2c(09:-1:1))
	chk.i(u2c(magic(4)), [], '%lu',  'ascend').o(u2c(16:-1:1))
	chk.i(u2c(magic(5)), [], '%lu',  'ascend').o(u2c(25:-1:1))
	chk.i(u2c(magic(6)), [], '%lu',  'ascend').o(u2c(36:-1:1))
	chk.i(u2c(magic(7)), [], '%lu',  'ascend').o(u2c(49:-1:1))
	chk.i(u2c(magic(8)), [], '%lu',  'ascend').o(u2c(64:-1:1))
	chk.i(u2c(magic(9)), [], '%lu',  'ascend').o(u2c(81:-1:1))
	chk.i(u2c(magic(0)), [], '%lu', 'descend').o(u2c(1:+1:00))
	chk.i(u2c(magic(1)), [], '%lu', 'descend').o(u2c(1:+1:01))
	chk.i(u2c(magic(2)), [], '%lu', 'descend').o(u2c(1:+1:04))
	chk.i(u2c(magic(3)), [], '%lu', 'descend').o(u2c(1:+1:09))
	chk.i(u2c(magic(4)), [], '%lu', 'descend').o(u2c(1:+1:16))
	chk.i(u2c(magic(5)), [], '%lu', 'descend').o(u2c(1:+1:25))
	chk.i(u2c(magic(6)), [], '%lu', 'descend').o(u2c(1:+1:36))
	chk.i(u2c(magic(7)), [], '%lu', 'descend').o(u2c(1:+1:49))
	chk.i(u2c(magic(8)), [], '%lu', 'descend').o(u2c(1:+1:64))
	chk.i(u2c(magic(9)), [], '%lu', 'descend').o(u2c(1:+1:81))
	chk.i(u2c(magic(0)), [],  'ascend', '%lu').o(u2c(00:-1:1))
	chk.i(u2c(magic(1)), [],  'ascend', '%lu').o(u2c(01:-1:1))
	chk.i(u2c(magic(2)), [],  'ascend', '%lu').o(u2c(04:-1:1))
	chk.i(u2c(magic(3)), [],  'ascend', '%lu').o(u2c(09:-1:1))
	chk.i(u2c(magic(4)), [],  'ascend', '%lu').o(u2c(16:-1:1))
	chk.i(u2c(magic(5)), [],  'ascend', '%lu').o(u2c(25:-1:1))
	chk.i(u2c(magic(6)), [],  'ascend', '%lu').o(u2c(36:-1:1))
	chk.i(u2c(magic(7)), [],  'ascend', '%lu').o(u2c(49:-1:1))
	chk.i(u2c(magic(8)), [],  'ascend', '%lu').o(u2c(64:-1:1))
	chk.i(u2c(magic(9)), [],  'ascend', '%lu').o(u2c(81:-1:1))
	chk.i(u2c(magic(0)), [], 'descend', '%lu').o(u2c(1:+1:00))
	chk.i(u2c(magic(1)), [], 'descend', '%lu').o(u2c(1:+1:01))
	chk.i(u2c(magic(2)), [], 'descend', '%lu').o(u2c(1:+1:04))
	chk.i(u2c(magic(3)), [], 'descend', '%lu').o(u2c(1:+1:09))
	chk.i(u2c(magic(4)), [], 'descend', '%lu').o(u2c(1:+1:16))
	chk.i(u2c(magic(5)), [], 'descend', '%lu').o(u2c(1:+1:25))
	chk.i(u2c(magic(6)), [], 'descend', '%lu').o(u2c(1:+1:36))
	chk.i(u2c(magic(7)), [], 'descend', '%lu').o(u2c(1:+1:49))
	chk.i(u2c(magic(8)), [], 'descend', '%lu').o(u2c(1:+1:64))
	chk.i(u2c(magic(9)), [], 'descend', '%lu').o(u2c(1:+1:81))
	n2c = @(m) arrayfun(@int2str,intmin('int64')+int64(m(:)-1),'uni',0);
	p2c = @(m) arrayfun(@int2str,intmax('int64')-int64(m(:)-1),'uni',0);
	chk.i(n2c(magic(0)), '[+-]?\d+', '%ld').o(n2c(1:+1:00))
	chk.i(n2c(magic(1)), '[+-]?\d+', '%ld').o(n2c(1:+1:01))
	chk.i(n2c(magic(2)), '[+-]?\d+', '%ld').o(n2c(1:+1:04))
	chk.i(n2c(magic(3)), '[+-]?\d+', '%ld').o(n2c(1:+1:09))
	chk.i(n2c(magic(4)), '[+-]?\d+', '%ld').o(n2c(1:+1:16))
	chk.i(n2c(magic(5)), '[+-]?\d+', '%ld').o(n2c(1:+1:25))
	chk.i(n2c(magic(6)), '[+-]?\d+', '%ld').o(n2c(1:+1:36))
	chk.i(n2c(magic(7)), '[+-]?\d+', '%ld').o(n2c(1:+1:49))
	chk.i(n2c(magic(8)), '[+-]?\d+', '%ld').o(n2c(1:+1:64))
	chk.i(n2c(magic(9)), '[+-]?\d+', '%ld').o(n2c(1:+1:81))
	chk.i(p2c(magic(0)), '[+-]?\d+', '%ld').o(p2c(00:-1:1))
	chk.i(p2c(magic(1)), '[+-]?\d+', '%ld').o(p2c(01:-1:1))
	chk.i(p2c(magic(2)), '[+-]?\d+', '%ld').o(p2c(04:-1:1))
	chk.i(p2c(magic(3)), '[+-]?\d+', '%ld').o(p2c(09:-1:1))
	chk.i(p2c(magic(4)), '[+-]?\d+', '%ld').o(p2c(16:-1:1))
	chk.i(p2c(magic(5)), '[+-]?\d+', '%ld').o(p2c(25:-1:1))
	chk.i(p2c(magic(6)), '[+-]?\d+', '%ld').o(p2c(36:-1:1))
	chk.i(p2c(magic(7)), '[+-]?\d+', '%ld').o(p2c(49:-1:1))
	chk.i(p2c(magic(8)), '[+-]?\d+', '%ld').o(p2c(64:-1:1))
	chk.i(p2c(magic(9)), '[+-]?\d+', '%ld').o(p2c(81:-1:1))
	chk.i(n2c(magic(0)), '[+-]?\d+', '%ld',  'ascend').o(n2c(1:+1:00))
	chk.i(n2c(magic(1)), '[+-]?\d+', '%ld',  'ascend').o(n2c(1:+1:01))
	chk.i(n2c(magic(2)), '[+-]?\d+', '%ld',  'ascend').o(n2c(1:+1:04))
	chk.i(n2c(magic(3)), '[+-]?\d+', '%ld',  'ascend').o(n2c(1:+1:09))
	chk.i(n2c(magic(4)), '[+-]?\d+', '%ld',  'ascend').o(n2c(1:+1:16))
	chk.i(n2c(magic(5)), '[+-]?\d+', '%ld',  'ascend').o(n2c(1:+1:25))
	chk.i(n2c(magic(6)), '[+-]?\d+', '%ld',  'ascend').o(n2c(1:+1:36))
	chk.i(n2c(magic(7)), '[+-]?\d+', '%ld',  'ascend').o(n2c(1:+1:49))
	chk.i(n2c(magic(8)), '[+-]?\d+', '%ld',  'ascend').o(n2c(1:+1:64))
	chk.i(n2c(magic(9)), '[+-]?\d+', '%ld',  'ascend').o(n2c(1:+1:81))
	chk.i(n2c(magic(0)), '[+-]?\d+', '%ld', 'descend').o(n2c(00:-1:1))
	chk.i(n2c(magic(1)), '[+-]?\d+', '%ld', 'descend').o(n2c(01:-1:1))
	chk.i(n2c(magic(2)), '[+-]?\d+', '%ld', 'descend').o(n2c(04:-1:1))
	chk.i(n2c(magic(3)), '[+-]?\d+', '%ld', 'descend').o(n2c(09:-1:1))
	chk.i(n2c(magic(4)), '[+-]?\d+', '%ld', 'descend').o(n2c(16:-1:1))
	chk.i(n2c(magic(5)), '[+-]?\d+', '%ld', 'descend').o(n2c(25:-1:1))
	chk.i(n2c(magic(6)), '[+-]?\d+', '%ld', 'descend').o(n2c(36:-1:1))
	chk.i(n2c(magic(7)), '[+-]?\d+', '%ld', 'descend').o(n2c(49:-1:1))
	chk.i(n2c(magic(8)), '[+-]?\d+', '%ld', 'descend').o(n2c(64:-1:1))
	chk.i(n2c(magic(9)), '[+-]?\d+', '%ld', 'descend').o(n2c(81:-1:1))
	chk.i(p2c(magic(0)), '[+-]?\d+', '%ld',  'ascend').o(p2c(00:-1:1))
	chk.i(p2c(magic(1)), '[+-]?\d+', '%ld',  'ascend').o(p2c(01:-1:1))
	chk.i(p2c(magic(2)), '[+-]?\d+', '%ld',  'ascend').o(p2c(04:-1:1))
	chk.i(p2c(magic(3)), '[+-]?\d+', '%ld',  'ascend').o(p2c(09:-1:1))
	chk.i(p2c(magic(4)), '[+-]?\d+', '%ld',  'ascend').o(p2c(16:-1:1))
	chk.i(p2c(magic(5)), '[+-]?\d+', '%ld',  'ascend').o(p2c(25:-1:1))
	chk.i(p2c(magic(6)), '[+-]?\d+', '%ld',  'ascend').o(p2c(36:-1:1))
	chk.i(p2c(magic(7)), '[+-]?\d+', '%ld',  'ascend').o(p2c(49:-1:1))
	chk.i(p2c(magic(8)), '[+-]?\d+', '%ld',  'ascend').o(p2c(64:-1:1))
	chk.i(p2c(magic(9)), '[+-]?\d+', '%ld',  'ascend').o(p2c(81:-1:1))
	chk.i(p2c(magic(0)), '[+-]?\d+', '%ld', 'descend').o(p2c(1:+1:00))
	chk.i(p2c(magic(1)), '[+-]?\d+', '%ld', 'descend').o(p2c(1:+1:01))
	chk.i(p2c(magic(2)), '[+-]?\d+', '%ld', 'descend').o(p2c(1:+1:04))
	chk.i(p2c(magic(3)), '[+-]?\d+', '%ld', 'descend').o(p2c(1:+1:09))
	chk.i(p2c(magic(4)), '[+-]?\d+', '%ld', 'descend').o(p2c(1:+1:16))
	chk.i(p2c(magic(5)), '[+-]?\d+', '%ld', 'descend').o(p2c(1:+1:25))
	chk.i(p2c(magic(6)), '[+-]?\d+', '%ld', 'descend').o(p2c(1:+1:36))
	chk.i(p2c(magic(7)), '[+-]?\d+', '%ld', 'descend').o(p2c(1:+1:49))
	chk.i(p2c(magic(8)), '[+-]?\d+', '%ld', 'descend').o(p2c(1:+1:64))
	chk.i(p2c(magic(9)), '[+-]?\d+', '%ld', 'descend').o(p2c(1:+1:81))
	chk.i(n2c(magic(0)), '[+-]?\d+',  'ascend', '%ld').o(n2c(1:+1:00))
	chk.i(n2c(magic(1)), '[+-]?\d+',  'ascend', '%ld').o(n2c(1:+1:01))
	chk.i(n2c(magic(2)), '[+-]?\d+',  'ascend', '%ld').o(n2c(1:+1:04))
	chk.i(n2c(magic(3)), '[+-]?\d+',  'ascend', '%ld').o(n2c(1:+1:09))
	chk.i(n2c(magic(4)), '[+-]?\d+',  'ascend', '%ld').o(n2c(1:+1:16))
	chk.i(n2c(magic(5)), '[+-]?\d+',  'ascend', '%ld').o(n2c(1:+1:25))
	chk.i(n2c(magic(6)), '[+-]?\d+',  'ascend', '%ld').o(n2c(1:+1:36))
	chk.i(n2c(magic(7)), '[+-]?\d+',  'ascend', '%ld').o(n2c(1:+1:49))
	chk.i(n2c(magic(8)), '[+-]?\d+',  'ascend', '%ld').o(n2c(1:+1:64))
	chk.i(n2c(magic(9)), '[+-]?\d+',  'ascend', '%ld').o(n2c(1:+1:81))
	chk.i(n2c(magic(0)), '[+-]?\d+', 'descend', '%ld').o(n2c(00:-1:1))
	chk.i(n2c(magic(1)), '[+-]?\d+', 'descend', '%ld').o(n2c(01:-1:1))
	chk.i(n2c(magic(2)), '[+-]?\d+', 'descend', '%ld').o(n2c(04:-1:1))
	chk.i(n2c(magic(3)), '[+-]?\d+', 'descend', '%ld').o(n2c(09:-1:1))
	chk.i(n2c(magic(4)), '[+-]?\d+', 'descend', '%ld').o(n2c(16:-1:1))
	chk.i(n2c(magic(5)), '[+-]?\d+', 'descend', '%ld').o(n2c(25:-1:1))
	chk.i(n2c(magic(6)), '[+-]?\d+', 'descend', '%ld').o(n2c(36:-1:1))
	chk.i(n2c(magic(7)), '[+-]?\d+', 'descend', '%ld').o(n2c(49:-1:1))
	chk.i(n2c(magic(8)), '[+-]?\d+', 'descend', '%ld').o(n2c(64:-1:1))
	chk.i(n2c(magic(9)), '[+-]?\d+', 'descend', '%ld').o(n2c(81:-1:1))
	chk.i(p2c(magic(0)), '[+-]?\d+',  'ascend', '%ld').o(p2c(00:-1:1))
	chk.i(p2c(magic(1)), '[+-]?\d+',  'ascend', '%ld').o(p2c(01:-1:1))
	chk.i(p2c(magic(2)), '[+-]?\d+',  'ascend', '%ld').o(p2c(04:-1:1))
	chk.i(p2c(magic(3)), '[+-]?\d+',  'ascend', '%ld').o(p2c(09:-1:1))
	chk.i(p2c(magic(4)), '[+-]?\d+',  'ascend', '%ld').o(p2c(16:-1:1))
	chk.i(p2c(magic(5)), '[+-]?\d+',  'ascend', '%ld').o(p2c(25:-1:1))
	chk.i(p2c(magic(6)), '[+-]?\d+',  'ascend', '%ld').o(p2c(36:-1:1))
	chk.i(p2c(magic(7)), '[+-]?\d+',  'ascend', '%ld').o(p2c(49:-1:1))
	chk.i(p2c(magic(8)), '[+-]?\d+',  'ascend', '%ld').o(p2c(64:-1:1))
	chk.i(p2c(magic(9)), '[+-]?\d+',  'ascend', '%ld').o(p2c(81:-1:1))
	chk.i(p2c(magic(0)), '[+-]?\d+', 'descend', '%ld').o(p2c(1:+1:00))
	chk.i(p2c(magic(1)), '[+-]?\d+', 'descend', '%ld').o(p2c(1:+1:01))
	chk.i(p2c(magic(2)), '[+-]?\d+', 'descend', '%ld').o(p2c(1:+1:04))
	chk.i(p2c(magic(3)), '[+-]?\d+', 'descend', '%ld').o(p2c(1:+1:09))
	chk.i(p2c(magic(4)), '[+-]?\d+', 'descend', '%ld').o(p2c(1:+1:16))
	chk.i(p2c(magic(5)), '[+-]?\d+', 'descend', '%ld').o(p2c(1:+1:25))
	chk.i(p2c(magic(6)), '[+-]?\d+', 'descend', '%ld').o(p2c(1:+1:36))
	chk.i(p2c(magic(7)), '[+-]?\d+', 'descend', '%ld').o(p2c(1:+1:49))
	chk.i(p2c(magic(8)), '[+-]?\d+', 'descend', '%ld').o(p2c(1:+1:64))
	chk.i(p2c(magic(9)), '[+-]?\d+', 'descend', '%ld').o(p2c(1:+1:81))
	%
end
%
%% Numbers and NaN %%
...
chk.i(H, [], 'num<char',  'ascend').o({'','1','1a','2','2a','10','10a','a','a1','a2','a10','aa','ab','ac','b','c'}, [5,4,14,10,7,3,13,12,2,11,8,1,9,6,16,15])
chk.i(H, [], 'num<char', 'descend').o({'c','b','ac','ab','aa','a10','a2','a1','a','10a','10','2a','2','1a','1',''}, [15,16,6,9,1,8,11,2,12,13,3,7,10,14,4,5])
chk.i(H, [], 'char<num',  'ascend').o({'','a','aa','ab','ac','a1','a2','a10','b','c','1','1a','2','2a','10','10a'}, [5,12,1,9,6,2,11,8,16,15,4,14,10,7,3,13])
chk.i(H, [], 'char<num', 'descend').o({'10a','10','2a','2','1a','1','c','b','a10','a2','a1','ac','ab','aa','a',''}, [13,3,7,10,14,4,15,16,8,11,2,6,9,1,12,5])
%
I =                                   {'a','1','b','10','','2','a2','a10','a1','a1y','a1z','a1x9','a1x10','a1x1','a1x'};
chk.i(I, [], 'num<char',  'ascend').o({'','1','2','10','a','a1','a1x','a1x1','a1x9','a1x10','a1y','a1z','a2','a10','b'}, [5,2,6,4,1,9,15,14,12,13,10,11,7,8,3])
chk.i(I, [], 'num<char', 'descend').o({'b','a10','a2','a1z','a1y','a1x10','a1x9','a1x1','a1x','a1','a','10','2','1',''}, [3,8,7,11,10,13,12,14,15,9,1,4,6,2,5])
chk.i(I, [], 'char<num',  'ascend').o({'','a','a1','a1x','a1x1','a1x9','a1x10','a1y','a1z','a2','a10','b','1','2','10'}, [5,1,9,15,14,12,13,10,11,7,8,3,2,6,4])
chk.i(I, [], 'char<num', 'descend').o({'10','2','1','b','a10','a2','a1z','a1y','a1x10','a1x9','a1x1','a1x','a1','a',''}, [4,6,2,3,8,7,11,10,13,12,14,15,9,1,5])
%
J =                                   {'aaa','111','a11','1a1','aa1','11a','a1a','1aa'};
chk.i(J, [], 'num<char',  'ascend').o({'1a1','1aa','11a','111','a1a','a11','aa1','aaa'}, [4,8,6,2,7,3,5,1])
chk.i(J, [], 'num<char', 'descend').o({'aaa','aa1','a11','a1a','111','11a','1aa','1a1'}, [1,5,3,7,2,6,8,4])
chk.i(J, [], 'char<num',  'ascend').o({'aaa','aa1','a1a','a11','1aa','1a1','11a','111'}, [1,5,7,3,8,4,6,2])
chk.i(J, [], 'char<num', 'descend').o({'111','11a','1a1','1aa','a11','a1a','aa1','aaa'}, [2,6,4,8,3,7,5,1])
%
K =                         {'1234','1200','129'};
chk.i(K,       '\d{1,2}').o({'1200','129','1234'}, [2,3,1], {12,34;12,0;12,9}) % quantifier
chk.i(K, '(?<=\d{2})\d+').o({'1200','129','1234'}, [2,3,1], {'12',34;'12',0;'12',9}) % lookaround assertion
%
dbgM = {10,[];NaN,'b';NaN,[];NaN,'c';1,[];NaN,NaN;2,[];NaN,'a';NaN,[];10,[]};
inpM =                                         {'10','NaNb','NaN','NaNc','1','NaNNaN','2','NaNa','NaN','10'};
chk.i(inpM, 'NaN|\d+', 'num<NaN',  'ascend').o({'1','2','10','10','NaN','NaN','NaNNaN','NaNa','NaNb','NaNc'}, [5,7,1,10,3,9,6,8,2,4], dbgM)
chk.i(inpM, 'NaN|\d+', 'num<NaN', 'descend').o({'NaNc','NaNb','NaNa','NaNNaN','NaN','NaN','10','10','2','1'}, [4,2,8,6,3,9,1,10,7,5], dbgM)
chk.i(inpM, 'NaN|\d+', 'NaN<num',  'ascend').o({'NaN','NaN','NaNNaN','NaNa','NaNb','NaNc','1','2','10','10'}, [3,9,6,8,2,4,5,7,1,10], dbgM)
chk.i(inpM, 'NaN|\d+', 'NaN<num', 'descend').o({'10','10','2','1','NaNc','NaNb','NaNa','NaNNaN','NaN','NaN'}, [1,10,7,5,4,2,8,6,3,9], dbgM)
%
%% Orientation %%
%
chk.i({}).o({}, [], {}) % empty!
...
%
chk.i({''}).o({''}, 1, cell(1,0))
chk.i({'hello'}).o({'hello'}, 1, {'hello'})
chk.i({'world','hello'}).o({'hello','world'}, [2,1], {'world';'hello'})
chk.i({'smile','world','hello'}).o({'hello','smile','world'}, [3,1,2], {'smile';'world';'hello'})
%
chk.i(...
	{'1';'10';'20';'2'}).o(...
	{'1';'2';'10';'20'}, [1;4;2;3])
...
chk.i(cfn(3,2,1)).o(cfn(3,2,1), reshape(1:6,3,2,1))
chk.i(cfn(3,1,2)).o(cfn(3,1,2), reshape(1:6,3,1,2))
chk.i(cfn(2,3,1)).o(cfn(2,3,1), reshape(1:6,2,3,1))
chk.i(cfn(2,1,3)).o(cfn(2,1,3), reshape(1:6,2,1,3))
chk.i(cfn(1,3,2)).o(cfn(1,3,2), reshape(1:6,1,3,2))
chk.i(cfn(1,2,3)).o(cfn(1,2,3), reshape(1:6,1,2,3))
%
%% Index Stability %%
%
chk.i(cfn(3,2,1), [],  'ascend').o(cfn(3,2,1), reshape(1:6,3,2,1), cfn(6,1))
chk.i(cfn(3,1,2), [],  'ascend').o(cfn(3,1,2), reshape(1:6,3,1,2), cfn(6,1))
chk.i(cfn(2,3,1), [],  'ascend').o(cfn(2,3,1), reshape(1:6,2,3,1), cfn(6,1))
chk.i(cfn(2,1,3), [],  'ascend').o(cfn(2,1,3), reshape(1:6,2,1,3), cfn(6,1))
chk.i(cfn(1,3,2), [],  'ascend').o(cfn(1,3,2), reshape(1:6,1,3,2), cfn(6,1))
chk.i(cfn(1,2,3), [],  'ascend').o(cfn(1,2,3), reshape(1:6,1,2,3), cfn(6,1))
chk.i(cfn(3,2,1), [], 'descend').o(cfn(3,2,1), reshape(1:6,3,2,1), cfn(6,1))
chk.i(cfn(3,1,2), [], 'descend').o(cfn(3,1,2), reshape(1:6,3,1,2), cfn(6,1))
chk.i(cfn(2,3,1), [], 'descend').o(cfn(2,3,1), reshape(1:6,2,3,1), cfn(6,1))
chk.i(cfn(2,1,3), [], 'descend').o(cfn(2,1,3), reshape(1:6,2,1,3), cfn(6,1))
chk.i(cfn(1,3,2), [], 'descend').o(cfn(1,3,2), reshape(1:6,1,3,2), cfn(6,1))
chk.i(cfn(1,2,3), [], 'descend').o(cfn(1,2,3), reshape(1:6,1,2,3), cfn(6,1))
%
xfn = @(n) reshape(1:n,[],1);
chk.i(cfn(0,1), [],  'ascend').o(cfn(0,1), xfn(0),       {})
chk.i(cfn(1,1), [],  'ascend').o(cfn(1,1), xfn(1), cfn(1,1))
chk.i(cfn(2,1), [],  'ascend').o(cfn(2,1), xfn(2), cfn(2,1))
chk.i(cfn(3,1), [],  'ascend').o(cfn(3,1), xfn(3), cfn(3,1))
chk.i(cfn(4,1), [],  'ascend').o(cfn(4,1), xfn(4), cfn(4,1))
chk.i(cfn(5,1), [],  'ascend').o(cfn(5,1), xfn(5), cfn(5,1))
chk.i(cfn(0,1), [], 'descend').o(cfn(0,1), xfn(0),       {})
chk.i(cfn(1,1), [], 'descend').o(cfn(1,1), xfn(1), cfn(1,1))
chk.i(cfn(2,1), [], 'descend').o(cfn(2,1), xfn(2), cfn(2,1))
chk.i(cfn(3,1), [], 'descend').o(cfn(3,1), xfn(3), cfn(3,1))
chk.i(cfn(4,1), [], 'descend').o(cfn(4,1), xfn(4), cfn(4,1))
chk.i(cfn(5,1), [], 'descend').o(cfn(5,1), xfn(5), cfn(5,1))
%
chk.i({}              ).o({}              ,     [],        {})
chk.i({''}            ).o({''}            , xfn(1), cell(1,0))
chk.i({'';''}         ).o({'';''}         , xfn(2), cell(2,0))
chk.i({'';'';''}      ).o({'';'';''}      , xfn(3), cell(3,0))
chk.i({'';'';'';''}   ).o({'';'';'';''}   , xfn(4), cell(4,0))
chk.i({'';'';'';'';''}).o({'';'';'';'';''}, xfn(5), cell(5,0))
%
U =                       {'2';'3';'2';'1';'2'};
...
%
raw = nsoPerms(6,2,[]);
[S,T,R] = nsoASCII(raw,'012abc'); chk.i(R, '\d', 'ascend', 'num<char').o(S), chk.i(R, '\d', 'descend', 'num<char').o(T)
[S,T,R] = nsoASCII(raw,'abc012'); chk.i(R, '\d', 'ascend', 'char<num').o(S), chk.i(R, '\d', 'descend', 'char<num').o(T)
raw = nsoPerms(6,3,[]);
[S,T,R] = nsoASCII(raw,'012abc'); chk.i(R, '\d', 'ascend', 'num<char').o(S), chk.i(R, '\d', 'descend', 'num<char').o(T)
[S,T,R] = nsoASCII(raw,'abc012'); chk.i(R, '\d', 'ascend', 'char<num').o(S), chk.i(R, '\d', 'descend', 'char<num').o(T)
raw = nsoPerms(6,4,[]);
...
%
raw = nsoPerms(8,2,[]);
[S,T,R] = nsoASCII(raw,'0123abcd'); chk.i(R, '\d', 'ascend', 'num<char').o(S), chk.i(R, '\d', 'descend', 'num<char').o(T)
[S,T,R] = nsoASCII(raw,'abcd0123'); chk.i(R, '\d', 'ascend', 'char<num').o(S), chk.i(R, '\d', 'descend', 'char<num').o(T)
raw = nsoPerms(8,3,[]);
[S,T,R] = nsoASCII(raw,'0123abcd'); chk.i(R, '\d', 'ascend', 'num<char').o(S), chk.i(R, '\d', 'descend', 'num<char').o(T)
[S,T,R] = nsoASCII(raw,'abcd0123'); chk.i(R, '\d', 'ascend', 'char<num').o(S), chk.i(R, '\d', 'descend', 'char<num').o(T)
raw = nsoPerms(8,4,[]);
...
chk.i(...
	{'Team 11','Team 3','Team 1'}).o(...
	{'Team 1','Team 3','Team 11'})
chk.i(...
	{'ver-1.3.12','ver-1.3.3','ver-1.2.5','ver-1.2.15','ver-1.2.3','ver-1.2.1'}).o(...
	{'ver-1.2.1','ver-1.2.3','ver-1.2.5','ver-1.2.15','ver-1.3.3','ver-1.3.12'})
chk.i(...
	{'C1H2','C1H4','C2H2','C2H6','C2N','C3H6'}).o(...
	{'C1H2','C1H4','C2H2','C2H6','C2N','C3H6'})
chk.i(...
	{'Team 101','Team 58','Team 30','Team 1'}).o(...
...
chk.i(...
	{'2 ft 7 in','1 ft 5 in','10 ft 2 in','2 ft 11 in','7 ft 6 in'}).o(...
	{'1 ft 5 in','2 ft 7 in','2 ft 11 in','7 ft 6 in','10 ft 2 in'})
chk.i(...
	{'version-1.9','version-2.0','version-1.11','version-1.10'}).o(...
	{'version-1.9','version-1.10','version-1.11','version-2.0'})
chk.i(...
	{'position5.10.data','position-3.data','position5.3.data','position2.data'}, '[+-]?\d+\.?\d*').o(...
	{'position-3.data','position2.data','position5.10.data','position5.3.data'})
chk.i(...
	{'1.2','1.2rc1','1.2beta2','1.2beta1','1.2alpha','1.2.1','1.1','1.3'}).o(...
	{'1.1','1.2','1.2.1','1.2alpha','1.2beta1','1.2beta2','1.2rc1','1.3'})
%
a =                                 {'a50','a51.','a+50.4','a5.034e1','a+50.300'};
chk.i(a, '\d+\.?\d*(E\d+)?'     ).o({'a50','a5.034e1','a51.','a+50.300','a+50.4'}) % no sign
chk.i(a, '[+-]?\d+\.?\d*(E\d+)?').o({'a50','a+50.300','a5.034e1','a+50.4','a51.'})
chk.i(a, '[+-]?\d+\.?\d*'       ).o({'a5.034e1','a50','a+50.300','a+50.4','a51.'}) % no exp
%
a =                       {'a2','a9','a1','a4','a10'};
chk.i(a               ).o({'a1','a2','a4','a9','a10'}, [3,1,4,2,5])
chk.i(a, [], 'descend').o({'a10','a9','a4','a2','a1'})
%
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%nsoMain
function C = nsoPerms(M,N,S)
% Generate all permutations with repetition, in lexicographical order.
C = {S};
if numel(S)<N
	for k = 1:M
		C = [C;nsoPerms(M,N,[S,k])]; %#ok<AGROW>
	end
end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%nsoPerms
function [C,D,R] = nsoASCII(C,V)
% Index into V using the content of C.
for k = 1:numel(C)
	C{k} = V(C{k});
end
D = C(end:-1:1);
R = C(randperm(numel(C)));
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%nsoASCII
...
% * a cell array where each column consists either exclusively of character row
...
% nested cell arrays correspond to the columns of the input array |A|.
